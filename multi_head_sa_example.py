# here we implement a multi-head self-attention from scratch
...
class FullModel(nn.Module):
    # progressively build the full language model --> here, focus is on the multi-head self-attention part
